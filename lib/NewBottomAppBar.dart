                ...
                children: <Widget>[
                  Container(
                    child: InkWell(
                      ...
                      onTap: () {},
                      child: Icon(CupertinoIcons.home, size: 45.0,
                  ...
                  Container(
                    child: InkWell(
                      ...
                      child: Icon(CupertinoIcons.time, size: 45.0,
                          color: Colors.black54),
                      onTap: () {},
                    ),
                ...
                children: <Widget>[
                  Container(
                    child: InkWell(
                      ...
                      child: Icon(CupertinoIcons.mail, size: 45.0,
                          color: Colors.black54),
                      onTap: () {},
                    ),
                  ...
                  Container(
                    child: InkWell(
                      ...
                      child: Icon(CupertinoIcons.profile_circled, size: 45.0,
                          color: Colors.black54),
                      onTap: () {},
                    ),
                    padding: EdgeInsets.only(left: 20.0, right: 20.0),
